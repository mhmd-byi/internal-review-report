            ...
            <div className="p-8 max-w-7xl mx-auto">
                ...
                <div className="flex gap-2 mb-6">
                    ...
                    <Button
                        ...
                        className={filter === 'sent' ? 'bg-sky-600 hover:bg-sky-700' : ''}
                    >
                        Sent to Management ({reports.filter(r => r.workflowStatus === 'Sent to Management').length})
                    </Button>
                    <Button
                        size="sm"
                        variant={filter === 'submitted' ? 'default' : 'outline'}
                        onClick={() => setFilter('submitted')}
                        className={filter === 'submitted' ? 'bg-blue-600 hover:bg-blue-700' : ''}
                    >
                    ...
                    >
                        Approved ({reports.filter(r => r.workflowStatus === 'Approved').length})
                    </Button>
                    <Button
                        size="sm"
